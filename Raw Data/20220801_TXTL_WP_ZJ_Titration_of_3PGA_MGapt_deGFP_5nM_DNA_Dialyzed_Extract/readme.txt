...
Experiment Protocol:
	...
	The composition is computed from the same Jupyter notebook used to create the Echo picklist.
	   (108 samples * 7.266uL/sample * 1.1 excess = 863 uL)
	...
	2. We use the Echo to load whatever is not in the minimal master mix into our sample wells, as defined by
	   our Echo picklist. We make sure to leave one well space between wells with different samples.
		...
		-----------	-------------------------		-----------
		    L10		3-PGA, diluted 3X to 467mM		65	
		    L11		3-PGA, diluted 3X to 467mM		30	
		    L13		Mg-glutamate, 100mM			65    
		    L14		Mg-glutamate, 100mM			35
		    L16		DNA,  228 ng/uL				65
		    L17		DNA,  228 ng/uL				36
		    L19		H2O					65
		    L20		H2O					65
		    L21		H2O					65
		    L22		H2O					65
...
Results:
- Same linear trend observed (i.e. optimal deGFP as 3-PGA increases with Mg).
- Same optimal TX at high Mg, low 3-PGA and optimal TL at low Mg, high 3-PGA.