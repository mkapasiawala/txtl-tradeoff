Description: We perform a salt calibration of the extract prepared by Alex Johnson, Miki Yun, and Manisha Kapasiawala in
July 2022 via the French Press and subsequent dialysis. We follow the lab's standard extract preparation protocol.
This extract had a protein concentration of roughly 30mg/ml using the Bradford assay.
...
Protocol: 
	...
	2. We use the Echo to load whatever is not in the minimal master mix into our sample wells, as defined by
	   our Echo picklist. We make sure to leave one well space between wells with different samples.
		...
		-----------	-------------------------		-----------
		    L01		Mg-glutamate, 100mM			42	
		    L03		K-glutamate, 1000mM			57	    
		    L05		DNA, 228 ng/uL				26
		    L07		Water					65
		    L08		Water					65
	3. Load 7.02uL of minimal master mix into each sample.
