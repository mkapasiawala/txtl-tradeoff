...
dynamics.
	In this experiment, we perform a 3-PGA vs Magnesium panel, using 1nM DNA template. We use a 
dialyzed, French-pressed extract. We use Midi-prepped DNA at 353 ng/uL. This experiment is being performed so that the DNA titration plot's points all use the same lysate.
...
Experiment Protocol:
	...
	The composition is computed from the same Jupyter notebook used to create the Echo picklist.
		...
		Extract					469
		PEG (40%)				71
		Minimal energy sol. (24.862 x)		57.1
		Amino acids				354.75
		K(3000mM)				37.84
	...
	2. We use the Echo to load whatever is not in the minimal master mix into our sample wells, as 
		...
		-----------	-------------------------		-----------
		    L19		3-PGA, diluted 3X to 467mM		65	
		    L20		3-PGA, diluted 3X to 467mM		30	
		    L22		Mg-glutamate, 100mM			65    
		    L23		Mg-glutamate, 100mM			43
		    M01		H2O					65
		    M02		H2O					65
		    M03		H2O					65
		    M04		H2O					65
		    M05		H2O					65
		    M06		H2O					65
	3. Load 7.28uL of minimal master mix into M18-M20. Then add 8.39uL DNA to master mix and add 7.34uL 		minimal master mix to remaining samples.
