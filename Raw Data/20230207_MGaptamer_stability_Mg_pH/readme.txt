...
fluorescence of MGaptamer changes in a different chemical environment.
...
3. Create an Echo picklist to dispense the following into each well, for 3 replicates per condition:
	...
	- 200nM final conc of MGaptamer mRNA
	- RNase inhibitor Murine at 0.5X concentration (from 40X stock)
	- Malachite Green dye
	- Water to 10uL
...
one well space between wells with different samples.
		...
		-----------	-------------------------		-----------
		B01			400mM Mg-glut			53
		B03			MGaptamer mRNA			45
		B05		RNase inhibitor Murine			53
		B07			Malachite Green			65
		B08			Malachite Green			25
		B10			NFW				65
		B11			NFW				65
		B12			NFW				65
...
Results:
- MGaptamer fluorescence is fairly stable across the Mg+2 and pH conditions surveyed here