...
dialyzed, French-pressed extract. We use newly Mini-prepped DNA at 670 ng/uL. The DNA was tested using a pre-made buffer. This expt is in a new lysate batch, DAJ_MK_MY2. The reporter plasmid used here is pMK19, which is a pTet-MGapt-deGFP plasmid. The plasmid is 3237 bp long.
...
Experiment Protocol:
	...
	2. We use the Echo to load whatever is not in the minimal master mix into our sample wells, as 
		...
		-----------	-------------------------		-----------
		    K20		3-PGA, diluted 3X to 467mM		65	
		    K21		3-PGA, diluted 3X to 467mM		30	
		    K23		Mg-glutamate, 100mM			65  
		    K24		Mg-glutamate, 100mM			43     
		    L01	 	H2O					65
		    L02		H2O					65
		    L03		H2O					65
		    L04		H2O					65
		    L05		H2O					65
	3. Load 7.29uL minimal master mix into M18-M20. Then add 22.1uL of DNA, 670 ng/uL. Finally, add 				7.45uL of minimal master mix into rest of the samples.
