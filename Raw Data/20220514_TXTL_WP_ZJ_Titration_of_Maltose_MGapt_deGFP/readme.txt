...
solution. We also create a malachite green solution to measure mRNA dynamics.
	In this experiment, we perform a maltose vs Magnesium panel.
...
Experiment Protocol:
	...
	2. We use the Echo to load whatever is not in the minimal master mix into our sample wells, as defined by
	   our Echo picklist. We make sure to leave one well space between wells with different samples.
		...
		-----------	-------------------------		-----------
		    G01		Maltose, diluted 3X to 467mM		65	
		    G02		Maltose, diluted 3X to 467mM		30	
		    G04		Mg-glutamate, 100mM			65    
		    G05		Mg-glutamate, 400mM			35
		    G07		DNA,  144 ng/uL				40
		    G09		H2O					65
		    G10		H2O					65
		    G11		H2O					65
		    G12		H2O					65
...
Results:
- Final protein yield is reduced with increasing [Mg]
- At high [maltose], [deGFP] begins to drop (from a previous steady state) after about 8 hours.
- It is not clear if protein is undergoing degradation or if there are conformational changes in deGFP due to pH changes.	