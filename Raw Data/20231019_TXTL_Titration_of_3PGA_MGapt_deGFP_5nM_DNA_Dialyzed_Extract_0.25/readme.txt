...
day before using a pre-made buffer. We decrease the volume fraction of cell lysate in the final
reaction from 0.33 to 0.25 (~25% decrease) to see whether the amount of cell machinery (and its control
...
Experiment Protocol:
	...
	2. We use the Echo to load whatever is not in the minimal master mix into our sample wells, as 
		...
		-----------	-------------------------		-----------
		    G01		3-PGA, diluted 3X to 467mM		65	
		    G02		3-PGA, diluted 3X to 467mM		30	
		    G04		Mg-glutamate, 200mM			55    
		    F20		H2O					65
		    F21		H2O					65
		    F22		H2O					65
		    F23		H2O					65
		    F24		H2O					65
	3. Load 7.76uL of minimal master mix into each sample.
...
Results:
	- Slope of tradeoff curve less steep compared to 33% lysate curve.