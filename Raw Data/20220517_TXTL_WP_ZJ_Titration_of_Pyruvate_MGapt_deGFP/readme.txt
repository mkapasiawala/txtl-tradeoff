...
solution. We also create a malachite green solution to measure mRNA dynamics.
	In this experiment, we perform a pyruvate vs Magnesium panel.
...
Experiment Protocol:
	1. Dilute 213ng/uL of DNA to 144ng/uL. (Combine 16.9uL of DNA with 8.1uL of H2O).
	...
	3. We use the Echo to load whatever is not in the minimal master mix into our sample wells, as defined by
	   our Echo picklist. We make sure to leave one well space between wells with different samples.
		...
		-----------	-------------------------		-----------
		    H01		Pyruvate, diluted 3X to 417mM		65	
		    H02		Pyruvate, diluted 3X to 417mM		35	
		    H04		Mg-glutamate, 100mM			65    
		    H05		Mg-glutamate, 400mM			35
		    H07		DNA,  144 ng/uL				40
		    H09		H2O					65
		    H10		H2O					65
		    H11		H2O					65
		    H12		H2O					65
...
Results:
- Increasing [pyruvate] shifts optimal [Mg+2] 
- With pyruvate as fuel, biphasic protein expression arises with increasing [Mg+2]