...
solution. We also create a malachite green solution to measure mRNA dynamics.
	In this experiment, we perform a 3-PGA vs Magnesium panel.
...
Experiment Protocol:
	...
	2. We use the Echo to load whatever is not in the minimal master mix into our sample wells, as defined by
	   our Echo picklist. We make sure to leave one well space between wells with different samples.
		...
		-----------	-------------------------		-----------
		    M01		3-PGA, diluted 3X to 467mM		65	
		    M02		3-PGA, diluted 3X to 467mM		30	
		    M04		Mg-glutamate, 100mM			65    
		    M05		Mg-glutamate, 400mM			35
		    M07		DNA,  144 ng/uL				40
		    M09		H2O					65
		    M10		H2O					65
		    M11		H2O					65
		    M12		H2O					65
...
Results:
- We see a clear positive correlation between Mg and 3-PGA concentration. That is, as we increase [3-PGA], a higher 
[Mg] is required to achieve the same concentration of deGFP expression.
- As we increase Mg concentration, we see an interesting biphasic protein expression, especially at lower [3-PGA].
- MG aptamer read poor due to low DNA concentration. Data collected but not shown here.						