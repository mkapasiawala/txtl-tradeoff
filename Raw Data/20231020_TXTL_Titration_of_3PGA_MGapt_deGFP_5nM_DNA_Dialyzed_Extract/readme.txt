...
day before using a pre-made buffer. Although we have done this expt before, the old data does not align
with the new data due to differences in DNA quality, so we repeat this expt for comparison with the 
DNA titration and extract titration expts.
...
Experiment Protocol:
	...
	2. We use the Echo to load whatever is not in the minimal master mix into our sample wells, as 
		...
		-----------	-------------------------		-----------
		    G06		3-PGA, diluted 3X to 467mM		65	
		    G07		3-PGA, diluted 3X to 467mM		30	
		    G09		Mg-glutamate, 200mM			55    
		    G11		H2O					65
		    G12		H2O					65
		    G13		H2O					65
	3. Load 8.46uL of minimal master mix into each sample.
...
Results:
	- New data aligns with all the recent data. Differences from previous 5nM, 33% lysate condition
		likely due to differences in DNA preparation.