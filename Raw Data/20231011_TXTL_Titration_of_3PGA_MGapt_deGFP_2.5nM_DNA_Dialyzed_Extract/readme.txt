...
dynamics.
	In this experiment, we perform a 3-PGA vs Magnesium panel, using 2.5nM DNA template. We use a 
dialyzed, French-pressed extract. We use newly Midi-prepped DNA at 353 ng/uL. The DNA was tested the 
day before using a pre-made buffer.
...
Experiment Protocol:
	...
	The composition is computed from the same Jupyter notebook used to create the Echo picklist.
		...
		NTPs (500mM)				13.74
		DNA, diluted 2x to 353/2 ng/uL		42.95
	2. We use the Echo to load whatever is not in the minimal master mix into our sample wells, as 
		...
		-----------	-------------------------		-----------
		    E01		3-PGA, diluted 3X to 467mM		65	
		    E02		3-PGA, diluted 3X to 467mM		30	
		    E04		Mg-glutamate, 100mM			65    
		    E05		Mg-glutamate, 100mM			43
		    E07		DNA, diluted 2x to 353/2 ng/uL		61
		    E09		H2O					65
		    E10		H2O					65
		    E11		H2O					65
		    E12		H2O					65
		    E13		H2O					65
	3. Load 7.57uL of minimal master mix into each sample.
...
Results:
	- Success! Data filled in the gap between 1nM and 5nM conditions.