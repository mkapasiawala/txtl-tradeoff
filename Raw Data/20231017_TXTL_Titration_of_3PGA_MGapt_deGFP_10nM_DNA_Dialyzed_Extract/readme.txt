...
dynamics.
	In this experiment, we perform a 3-PGA vs Magnesium panel, using 10nM DNA template. We use a 
...
Experiment Protocol:
	...
	2. We use the Echo to load whatever is not in the minimal master mix into our sample wells, as 
		...
		-----------	-------------------------		-----------
		    F01		3-PGA, diluted 3X to 467mM		65	
		    F02		3-PGA, diluted 3X to 467mM		30	
		    F04		Mg-glutamate, 100mM			65    
		    F05		Mg-glutamate, 100mM			43
		    F07		H2O					65
		    F08		H2O					65
		    F09		H2O					65
		    F10		H2O					65
	3. Load 7.87uL of minimal master mix into each sample.
