...
solution. We also create a malachite green solution to measure mRNA dynamics.
	In this experiment, we perform a 3-PGA vs Magnesium panel, albeit unlike the 20220513 expt, we use 5nM DNA 
template instead of 1nM.
...
Experiment Protocol:
	...
	2. We use the Echo to load whatever is not in the minimal master mix into our sample wells, as defined by
	   our Echo picklist. We make sure to leave one well space between wells with different samples.
		...
		-----------	-------------------------		-----------
		    F08		3-PGA, diluted 3X to 467mM		65	
		    F09		3-PGA, diluted 3X to 467mM		30	
		    F11		Mg-glutamate, 100mM			65    
		    F12		Mg-glutamate, 100mM			35
		    F14		DNA,  228 ng/uL				65
		    F15		DNA,  228 ng/uL				36
		    F17		H2O					65
		    F18		H2O					65
		    F19		H2O					65
...
Results:
- Basically the same results as before; as we increase 3-PGA, we need more Mg
- With more DNA, the malachite green signal is more pronounced; we see that transcription is optimal at high Mg and low 
3-PGA, which is different/opposite from the optimal concentrations for protein expression.