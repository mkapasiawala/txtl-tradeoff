...
dialyzed, French-pressed extract. We use newly Mini-prepped DNA at 569 ng/uL. The DNA was tested using a pre-made buffer. This expt is in a new lysate batch, DAJ_MK_MY2. The reporter plasmid used here is pMK18, which is a T7-MGapt-deGFP plasmid and compares in deGFP expression to pZJQ.34. The plasmid is 3224 bp long.
This is a repeat of the 20240212 expt, albeit with 10uM T7RNAP instead of 5uM.
...
Experiment Protocol:
	...
	2. We use the Echo to load whatever is not in the minimal master mix into our sample wells, as 
		...
		-----------	-------------------------		-----------
		    L07		3-PGA, diluted 3X to 467mM		65	
		    L08		3-PGA, diluted 3X to 467mM		30	
		    L10		Mg-glutamate, 100mM			65  
		    L11		Mg-glutamate, 100mM			43     
		    L13	 	H2O					65
		    L14		H2O					65
		    L15		H2O					65
		    L16		H2O					65
		    L17		H2O					65
	3. Load 7.41uL minimal master mix into G18-G20. Then add 25.92uL of DNA, 569 ng/uL. Finally, add 				7.60uL of minimal master mix into rest of the samples.
