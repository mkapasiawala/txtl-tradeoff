...
solution. We also create a malachite green solution to measure mRNA dynamics.
	In this experiment, we perform a maltose vs Magnesium panel, albeit with 5nM template DNA.
...
Experiment Protocol:
	...
	2. We use the Echo to load whatever is not in the minimal master mix into our sample wells, as defined by
	   our Echo picklist. We make sure to leave one well space between wells with different samples.
		...
		-----------	-------------------------		-----------
		    E21		Maltose, diluted 3X to 467mM		65	
		    F21		Maltose, diluted 3X to 467mM		30	
		    H21		Mg-glutamate, 100mM			65    
		    I21		Mg-glutamate, 400mM			35
		    K21		DNA,  228 ng/uL				65
		    L21		DNA,  228 ng/uL				30
		    N21		H2O					65
		    O21		H2O					65
		    P21		H2O					65
...
Results:
	- Maximum deGFP expression occurs at 0mM Mg+2 and low maltose
	- Maximum mRNA expression occurs where maltose and Mg+2 are both high