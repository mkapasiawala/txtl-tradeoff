...
solution. We also create a malachite green solution to measure mRNA dynamics.
	In this experiment, we perform a pyruvate vs Magnesium panel, albeit with 5nM DNA.
...
Experiment Protocol:
	...
	3. We use the Echo to load whatever is not in the minimal master mix into our sample wells, as defined by
	   our Echo picklist. We make sure to leave one well space between wells with different samples.
		...
		-----------	-------------------------		-----------
		    M09		Pyruvate, diluted 2.75X to 455mM	65	
		    M10		Pyruvate, diluted 2.75X to 455mM	30	
		    M12		Mg-glutamate, 100mM			65    
		    M13		Mg-glutamate, 100mM			35
		    M15		DNA,  228 ng/uL				65
		    M16		DNA,  228 ng/uL				30
		    M18		H2O					65
		    M19		H2O					65
		    M20		H2O					65
	   For creating 2.75X-diluted pyruvate, combine 40uL stock pyruvate with 70uL nuclease-free water.
	4. Load 7.47uL of minimal master mix into each sample.
...
Results:
	- Maximum deGFP expression occurs at 0mM Mg+2 and low pyruvate
	- Maximum mRNA expression occurs where pyruvate is low and Mg+2 is high