...
dynamics.
	In this experiment, we perform a 3-PGA vs Magnesium panel, using 7.5nM DNA template. We use a 
...
Experiment Protocol:
	...
	2. We use the Echo to load whatever is not in the minimal master mix into our sample wells, as 
		...
		-----------	-------------------------		-----------
		    E15		3-PGA, diluted 3X to 467mM		65	
		    E16		3-PGA, diluted 3X to 467mM		30	
		    E18		Mg-glutamate, 100mM			65    
		    E19		Mg-glutamate, 100mM			43
		    E21		H2O					65
		    E22		H2O					65
		    E23		H2O					65
		    E24		H2O					65
	3. Load 7.72uL of minimal master mix into each sample.
