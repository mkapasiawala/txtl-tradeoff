...
dialyzed, French-pressed extract. We use newly Midi-prepped DNA at 353 ng/uL. The DNA was tested using a pre-made buffer. This expt is in a new lysate batch, DAJ_MK_MY2.
...
Experiment Protocol:
	...
	2. We use the Echo to load whatever is not in the minimal master mix into our sample wells, as 
		...
		-----------	-------------------------		-----------
		    I04		3-PGA, diluted 3X to 467mM		65	
		    I05		3-PGA, diluted 3X to 467mM		30	
		    I07		Mg-glutamate, 100mM			65  
		    I08		Mg-glutamate, 100mM			43     
		    I10 	H2O					65
		    I11		H2O					65
		    I12		H2O					65
		    I13		H2O					65
		    I14		H2O					65
	3. Load 7.28uL minimal master mix into M18-M20. Then add 42uL of DNA, 353 ng/uL. Finally, add 				7.58uL of minimal master mix into rest of the samples.
...
Results:
	- TX-TL trade-off holds, position along curve is determined by fuel concentration
	- deGFP yields lower than expected compared to lysate 2 (as predicted by worse performance
		during salt calibration)