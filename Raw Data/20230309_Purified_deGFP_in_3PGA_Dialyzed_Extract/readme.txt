Description: We add purified deGFP to the different reaction conditions (using 3PGA) to see if deGFP
fluorescence is affected by the reaction conditions in a predictable manner.
...
Experiment Protocol:
	...
	2. We use the Echo to load whatever is not in the minimal master mix into our sample wells, as 
	   ...
	   different samples.
		...
		-----------	-------------------------		-----------
		    J05		3-PGA, diluted 3X to 467mM		65	
		    J06		3-PGA, diluted 3X to 467mM		30	
		    J08		Mg-glutamate, 100mM			65    
		    J09		Mg-glutamate, 100mM			43
		    J11		H2O					65
		    J12		H2O					65
		    J13		H2O					65
		    J14		H2O					65
		    J15		H2O					65
	3. Load 7.54uL of minimal master mix into each sample.
	4. Incubate reaction for 18 hours.
	5. Perform the following BioTek protocol.
		  Start Kinetic	Runtime 00:30:00 (HH:MM:SS), Interval 0:03:00, 193 Reads							
...
Results:
- deGFP fluorescence doesn't change much with TX-TL reaction condition, although we observe a 25-30%
overall increase in fluorescence.